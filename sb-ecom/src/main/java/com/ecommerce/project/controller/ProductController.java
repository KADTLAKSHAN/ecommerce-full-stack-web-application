...
public class ProductController {
    ...
    public ResponseEntity<ProductDTO> addProductForSeller(@Valid @RequestBody ProductDTO productDTO, @PathVariable Long categoryId){
    ...
    public ResponseEntity<ProductDTO> updateProductForSeller(@RequestBody ProductDTO productDTO, @PathVariable Long productId){
    ...
    @PutMapping("/seller/product/{productId}/image")
