...
public class AuthServiceImpl implements AuthService{
    ...
    public AuthenticationResult login(LoginRequest loginRequest) {
        ...
        UserInfoResponse response = new UserInfoResponse(userDetails.getId(),userDetails.getUsername(),userDetails.getEmail(), roles, jwtCookie.toString());
    ...
    @Override
    public ResponseEntity<?> createSeller(SignupRequest signupRequest) {
        if (userRepository.existsByUserName(signupRequest.getUsername())) {
            return ResponseEntity.badRequest().body(new MessageResponse("Error: Username is already taken!"));
        }
        ...
        return ResponseEntity.ok(new MessageResponse("Seller created successfully!"));
    }
}
